...
use Fiscal\Core\Contracts\CertificateProviderInterface;
use Fiscal\Core\Contracts\HttpTransportInterface;
use Fiscal\Core\Contracts\XmlValidatorInterface;
use Fiscal\Core\Transport\HttpRequest;
use Nfse\Client\Contracts\EndpointResolverInterface;
use Nfse\Client\Contracts\NfseClientInterface;
...
use Nfse\Client\Exceptions\ApiException;
